...
class TestStickersRepository(unittest.TestCase):
    def setUp(self):
        ...
        testdb.execute("INSERT INTO UserStickers (user_id, sticker_id) VALUES (0, 0)")
        self.testdb =testdb
    ...
    def test_remove_sticker(self):
        ...
        return
        self.assertEqual(self.repo.remove_sticker(2,3), True) #returns true if sticker was removed
        self.assertEqual(self.repo.remove_sticker(2,5), False) #returns false if nothing was removed
